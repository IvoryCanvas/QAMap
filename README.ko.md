...
npm 패키지와 플러그인은 별도로 업데이트됩니다. 0.5.0의 보고서 기반 검수 방식과
실측 결과의 한계는 [릴리즈 문서](docs/releases/0.5.0.md)에서 확인할 수 있습니다.
...
0.5.0부터 제공하는 [한 번에 검수 근거 받기](docs/ko/agent-handoff.md)도 확인할 수 있습니다.
