...
fresh fixture, home directory and session per run, no MCP servers, identical tools and prompt; the
QAMap arm's project was initialized with `init --agent --review-mode report` and its
