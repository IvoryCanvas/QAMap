...
- Preserve independent diff-only file groups and distinct intent-backed flows that share one source file; common syntax, UI controls, and routing verbs are not relationship evidence.
